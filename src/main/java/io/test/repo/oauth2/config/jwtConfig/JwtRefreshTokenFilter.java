...
public class JwtRefreshTokenFilter extends OncePerRequestFilter {
	Logger log = LoggerFactory.getLogger(JwtRefreshTokenFilter.class);
		...
		try {
			...
			if (!userName.isEmpty() && SecurityContextHolder.getContext().getAuthentication() == null) {
				...
				if (jwtTokenUtils.isTokenValid(jwtRefreshToken, userDetails) && isRefreshTokenValidInDatabase) {
					...
					UsernamePasswordAuthenticationToken createdToken = new UsernamePasswordAuthenticationToken(userDetails, null,
